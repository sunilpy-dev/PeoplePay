...
import payrollControlRoutes from './routes/payrollControlRoutes.js';
...
app.use('/api/v1/payroll/control', payrollControlRoutes);
app.use('/api/v1/payroll', payrollConfigRoutes);
